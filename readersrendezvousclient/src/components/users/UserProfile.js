    ...
    <div className = "UsersProfilePageContainer">
        <div className="UsersProfileContainer">
                ...
                <section className="UsersProfileSection">
                    <div className="UsersProfileDetail">Name: {usersProfile.firstName} {usersProfile.lastName}</div>
                    <div className="UsersProfileDetail">Email: {usersProfile.email}</div>
                    <div className="UsersProfileDetail">Library Card Number: {usersProfile.libraryCardNumber}</div>
                    <div className="UsersProfileDetail">Address Line One: {usersProfile.addressLineOne}</div>
                    <div className="UsersProfileDetail">Address Line Two: {usersProfile.addressLineTwo}</div>
